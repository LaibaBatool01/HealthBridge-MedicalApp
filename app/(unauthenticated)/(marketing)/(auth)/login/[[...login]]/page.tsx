...
import { ArrowRight, Heart, Shield, Stethoscope, Clock, Users, MessageCircle } from "lucide-react"
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2 lg:gap-20">
        {/* Left side - Medical platform benefits */}
        <motion.div
        ...
        >
          <div className="space-y-4">
            ...
            >
              Access your health records, consultations, and continue receiving quality medical care.
            </motion.p>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Patient rating</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <Heart className="h-5 w-5 text-green-600 dark:text-green-400 fill-current" />
            </motion.div>
            <div className="flex-1">
              <p className="text-sm font-medium">Trusted Healthcare Platform</p>
