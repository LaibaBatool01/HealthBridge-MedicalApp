      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        >
          <div className="group ring-border hover:bg-accent hover:text-accent-foreground relative inline-flex items-center rounded-full px-3 py-1 text-xs leading-6 shadow-sm ring-1 transition-colors sm:text-sm">
            ...
            <span className="inline">Trusted Healthcare Platform</span>
        ...
        >
          Connect with verified doctors, share symptoms, receive prescriptions, and get personalized care - all from the comfort of your home.
        </motion.p>
        <motion.div
        ...
        >
          {["Licensed Doctors", "Secure Platform", "24/7 Support"].map(
            (text, i) => (
              <motion.div
                key={text}
